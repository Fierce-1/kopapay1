...
import {View, Text, StyleSheet, TouchableOpacity, TextInput, Alert, ImageBackground, ScrollView, Dimensions} from 'react-native';
        ...
        <View style={styles.container1}>
            ...
            <ImageBackground source={image} resizeMode="cover" style={styles.image}>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <App_icon imgStyle={{marginTop: '2%', marginStart: '27%', height: windowHeight * 0.1, width: windowWidth * 0.2}} img={logo}/>
                </View>
